...
*/
@ActorServiceAttribute(name = "<%= serviceName %>")
@StatePersistenceAttribute(statePersistence = StatePersistence.Persisted)
public class <%= actorName %>Impl extends FabricActor implements <%= actorName %> {
    private Logger logger = Logger.getLogger(this.getClass().getName());

    public <%= actorName %>Impl(FabricActorService actorService, ActorId actorId){
